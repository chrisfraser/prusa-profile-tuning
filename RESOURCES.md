...
- [`reference/source-material/esun-starter-profiles-bundle.ini`](reference/source-material/esun-starter-profiles-bundle.ini)
  Importable PrusaSlicer config bundle, 24 presets: 12 filament + 12 print, 0.4 and 0.6 mm nozzles,
  print speeds pre-clamped to each filament's MVS. Downloaded and imported in Lesson 9.
